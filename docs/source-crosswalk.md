...
| `environment-life-review-forge` | Environmental/ecological/life-science adaptation, including agroecosystem nutrient meta-analysis and scenario-model evidence synthesis | CEE standards, JBI, ecology/evolution meta-analysis handbook, environmental nutrient-meta and scenario-model examples | Do not pool across incompatible species, exposures, endpoints, geography, measurement platforms, soil-depth conventions, durations, or policy scenarios; separate predictive models from causal claims |
